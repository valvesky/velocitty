...
- `draw.zig` — CPU framebuffer; line-dirty fill + SIMD glyph blit; cell-span dirty when a prev snapshot exists; DECSCNM reverse; styled/colored underlines; C0 cells are not rasterized; Debug overlay (grid, wrap, LCF, dirty, region, wide, HUD)
